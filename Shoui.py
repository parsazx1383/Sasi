...
def generate_payment_invoice(user_id, amount, description=None, email=None, mobile=None):
    ...
    """
    url = "https://sandbox.zarinpal.com/pg/rest/WebGate/PaymentRequest.json" if ZARINPAL_SANDBOX else "https://www.zarinpal.com/pg/rest/WebGate/PaymentRequest.json"
    
    data = {
        "MerchantID": ZARINPAL_MERCHANT,
        "Amount": amount * 10,  # تبدیل به ریال (تومان * 10)
        "CallbackURL": ZARINPAL_CALLBACK_URL,
        "Description": description or ZARINPAL_DESCRIPTION,
    }
    ...
    try:
        ...
        if result['Status'] == 100:
            ...
            payment_url = f"https://sandbox.zarinpal.com/pg/StartPay/{authority}" if ZARINPAL_SANDBOX else f"https://www.zarinpal.com/pg/StartPay/{authority}"
            return {
                "success": True,
                "authority": authority,
            ...
            return {
                "success": False,
                "message": f"خطا در ایجاد لینک پرداخت. کد خطا: {result['Status']}"
            }
    except Exception as e:
        return {
            "success": False,
...
def verify_payment(authority, amount):
    ...
    """
    url = "https://sandbox.zarinpal.com/pg/rest/WebGate/PaymentVerification.json" if ZARINPAL_SANDBOX else "https://www.zarinpal.com/pg/rest/WebGate/PaymentVerification.json"
    ...
    try:
        ...
        if result['Status'] == 100:
            ...
            return {
                "success": False,
                "message": f"پرداخت ناموفق. کد خطا: {result['Status']}"
            }
    except Exception as e:
        return {
            "success": False,
